...
from anumodana.output_paths import correction_output_path
from anumodana.transcript import Cue, parse_vtt, render_vtt
...
def parse_args(
    ...
    *,
    ...
    parser = argparse.ArgumentParser(
        prog=prog,
        description="Naive local LLM correction pass for VTT subtitles.",
    )
...
def default_output_path(input_path: Path) -> Path:
    return correction_output_path(input_path)
...
def main(
    ...
    *,
    ...
    output_path = Path(args.output_path).expanduser().resolve() if args.output_path else default_output_path(input_path)
